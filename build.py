...
BLOG_POSTS.append({
    ...
    <div class="summary-box">
      ...
      <ul>
        <li>중간고사 영어는 <b>본문 분석 → 문법 → 어휘 → 서술형</b> 순서로 준비하세요.</li>
        <li>시험 3주 전 시작이 가장 여유 있고, 지금 시작해도 늦지 않아요.</li>
        <li>화상과외는 화면 공유 첨삭과 수업 녹화로 시험 대비에 잘 맞아요.</li>
        <li>30분 무료체험수업으로 현재 실력과 시험 범위를 먼저 점검할 수 있어요.</li>
      </ul>
    </div>

    <p>군산제일중학교 영어과외를 알아보시는 학부모님이라면, 중간고사가 다가올수록 아이가 뭐부터 공부해야 할지 몰라 막막해하는 모습을 보신 적이 있을 거예요.</p>
    <p>교과서 지문을 외워야 하는지, 문법 문제집을 더 풀어야 하는지, 단어부터 다시 잡아야 하는지 우선순위가 헷갈리는 경우가 정말 많습니다.</p>
    <p>내신 영어는 범위가 정해져 있어서 전략적으로 접근하면 단기간에도 점수를 올릴 수 있는 과목이에요. 이 글에서는 군산제일중학교 학생이 중간고사를 어떤 순서로 준비하면 좋을지 정리해드릴게요.</p>

    <h2>1. 계획 없이 공부하면 시간만 흘러가요</h2>
    <p>시험 범위가 나오면 대부분 교과서를 여러 번 읽는 것부터 시작하지만, 이것만으로는 서술형과 변형 문제에 대비하기 어렵습니다.</p>
    <p>범위 안에는 아래 네 가지가 섞여 있어요.</p>
    <ul>
      <li><b>본문 암기와 해석</b> — 문장 구조를 이해해야 변형 문제에 대응돼요.</li>
      <li><b>문법 포인트</b> — 이론만 알면 서술형에서 틀리기 쉬워요.</li>
      <li><b>어휘</b> — 문장 속에서 쓰임까지 익혀야 오래 남아요.</li>
      <li><b>서술형·듣기</b> — 배점이 크지만 가장 늦게 챙기게 되는 영역이에요.</li>
    </ul>
    <p>계획 없이 손에 잡히는 대로 공부하면 배점이 큰 영역을 놓치고 시간만 쓰게 됩니다. 평소 실력은 있는데 점수가 안 나오는 학생들은 대부분 실력이 아니라 <strong>전략</strong>이 문제예요.</p>
    <p>남은 날짜를 역산해서 하루하루 해야 할 분량을 구체적으로 나눠보는 것이 첫걸음이고, 계획을 세우는 것 자체가 막막하다면 전문가와 함께 정리하는 것만으로도 부담이 크게 줄어듭니다.</p>

    <h2>2. 시험 3주 전부터의 단계별 학습법</h2>
    <p>효과적인 내신 영어 대비는 아래 순서로 진행하는 것을 추천드려요.</p>
    <ol>
      <li><b>본문 구조 분석</b> — 문장을 쪼개 왜 그렇게 해석되는지 이해합니다. 단순 암기보다 오래 기억에 남아요.</li>
      <li><b>문법 포인트 정리</b> — 범위에 나오는 문법을 정리하고 관련 문제로 적용해봅니다.</li>
      <li><b>어휘 암기</b> — 단어만 외우지 말고 문장 속 쓰임까지 함께 익힙니다.</li>
      <li><b>서술형 쓰기 연습</b> — 예상 문제를 직접 써보고 감점 없이 완성하는 연습을 반복합니다.</li>
    </ol>
    <div class="callout">
      <strong>이런 실수 조심하세요</strong>
      철자 하나, 대소문자 하나로도 서술형은 감점돼요. 혼자 문제집만 풀면 알아채기 어렵고, 경험 있는 선생님이 옆에서 하나씩 짚어줘야 확실히 줄일 수 있습니다.
    </div>
    <p>서술형은 채점 기준이 학교마다 조금씩 달라서, 학교 시험 스타일을 파악하고 있는 선생님과 연습하는 것이 가장 실전에 가까운 대비가 됩니다.</p>

    <h2>3. 화상과외로 하는 시험 대비</h2>
    <p>화상과외는 시험 대비에서도 충분히 효과적이에요. 대면 수업 못지않은 밀도로 진행할 수 있는 이유는 다음과 같습니다.</p>
    <ul>
      <li><b>화면 공유 첨삭</b> — 아이가 쓴 서술형 답안을 그 자리에서 첨삭하고 왜 틀렸는지 바로 설명해요.</li>
      <li><b>이동 시간 없음</b> — 시험 직전 주에는 하루 30분씩 짧고 잦게 수업을 잡을 수 있어요.</li>
      <li><b>수업 녹화</b> — 시험 직전에 헷갈렸던 부분만 다시 돌려볼 수 있어요.</li>
      <li><b>선생님 선택 폭</b> — 군산 안에서만 찾을 때보다 내신 대비 경험이 많은 선생님을 만날 확률이 높아요.</li>
    </ul>
    <p>시험 전날에는 새로운 내용을 늘리기보다 정리한 내용을 가볍게 복습하며 마음을 편안하게 다지는 방향으로 수업을 조정합니다. 긴장이 심한 학생이라면 짧은 대화만으로도 한결 편안해지는 경우가 많아요.</p>

    <h2>4. 시험 대비 선생님, 이렇게 고르세요</h2>
    <p>선생님을 고를 때는 아래 네 가지를 확인해보세요.</p>
    <div class="cmp-wrap"><table class="cmp">
      <thead><tr><th>확인할 점</th><th>왜 중요할까요</th></tr></thead>
      <tbody>
        <tr><td>학교별 출제 경향 파악</td><td>학교마다 서술형 비중과 유형이 달라요</td></tr>
        <tr><td>서술형 감점 요인 첨삭</td><td>아깝게 잃는 점수를 줄일 수 있어요</td></tr>
        <tr><td>남은 기간에 맞춘 현실적 계획</td><td>무리한 계획은 아이를 지치게 해요</td></tr>
        <tr><td>아이와의 궁합</td><td>편하게 질문할 수 있어야 효과가 커요</td></tr>
      </tbody>
    </table></div>
    <p>이런 부분은 짧은 상담만으로는 알기 어려워서 체험 수업으로 직접 확인하시는 게 가장 확실합니다. 상담 때는 아이가 자주 틀리는 유형과 서술형에서 어려워하는 부분을 알려주시고, 이전 시험 성적표나 오답노트가 있으면 함께 공유해주세요. 훨씬 현실적인 계획을 세울 수 있습니다.</p>

    <h2>5. 시험이 끝난 뒤가 더 중요해요</h2>
    <p>시험이 끝나면 영어 공부도 잠시 손을 놓기 쉽지만, 어떤 부분이 부족했는지 가장 선명하게 드러나는 시기가 바로 시험 직후예요.</p>
    <ul>
      <li>틀린 문제는 <b>왜 틀렸는지</b> 문법 개념부터 다시 짚어보세요.</li>
      <li>서술형 감점은 <b>어떤 표현이 문제였는지</b> 확인하고 넘어가세요.</li>
      <li>시험 직후 30분 오답 정리가 벼락치기 몇 시간보다 효율적입니다.</li>
    </ul>
    <p>군산제일중학교 학생들을 지도하다 보면 시험 직후 오답 정리를 꼼꼼히 한 학생과 그냥 넘어간 학생의 다음 시험 성적 차이가 확연히 드러납니다.</p>
    <p>이런 꾸준함을 혼자 유지하기 어렵다면 정기적으로 함께 점검해줄 선생님이 있는 것이 큰 도움이 돼요. 이번 시험 결과를 다음 시험의 자료로 삼는 습관이 장기적으로 훨씬 좋은 성적으로 이어집니다.</p>

    <h2>6. 군산제일중학교 영어과외, 지금 시작하세요</h2>
    <ul class="check-list">
      <li>시험 범위와 남은 기간에 맞춰 우선순위를 정해드려요.</li>
      <li>비용은 남은 기간과 수업 횟수에 따라 달라져서 상담 시 정확히 안내해 드려요.</li>
      <li><b>30분 무료체험수업</b>으로 현재 실력과 시험 범위를 먼저 점검해보세요.</li>
      <li>군산 관내 모든 중학교 학생과 매칭 가능해요.</li>
    </ul>
    <p>남은 시간이 촉박하게 느껴지셔도 괜찮아요. 지금 바로 편하게 상담 문의해주세요.</p>
    <p>중간고사는 학기 중 여러 시험 중 하나일 뿐이니, 이번 시험을 계기로 앞으로 이어질 학습 습관까지 함께 잡아가시길 바랍니다. 한 번 세워둔 시험 대비 습관은 다음 시험, 그다음 학기까지 든든한 자산이 되어줍니다.</p>
    <div class="mid-cta"><strong>시험이 얼마 안 남았다면 지금이 가장 빠른 시작점이에요</strong><br>재학 중인 학교와 시험 범위를 알려주시면 맞춰서 안내해 드립니다. <a class="cta-btn" href="../apply.html">무료체험 신청</a></div>
    ...
    직접 답안을 써서 화면으로 공유하면 선생님이 실시간으로 첨삭하며 감점 요인을 짚어드려요.</p>
