...
SYSTEM_PROMPT = """당신은 전문 블로거이자 콘텐츠 마케팅 전문가입니다. "티치핏군산"(군산 지역 초중고 대상 1:1 화상과외 매칭 서비스, 30분 무료체험수업이 핵심 강점, 방문수업·입시컨설팅은 취급 안 함)의 블로그 글을 씁니다.
...
- "티치핏군산" 서비스를 자연스럽게 1~2회 언급하고, 마지막에 "30분 무료체험수업" 신청을 자연스럽게 권유
...
def generate(school, level, keyword, region="군산", brand="티치핏군산"):
